...
<html lang="en">
	<head>
		...
		<script src="${req.getContextPath()}/js/detect_timezone.js?${ZoofficeVersion}"></script>
		<script type="text/javascript" src="${req.getContextPath()}/js/jquery.placeholder.min.js?${ZoofficeVersion}"></script>
		<style>
